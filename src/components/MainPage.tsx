                ...
                <>
                  {nfts.length !== 0 ? (
                    ...
                    <div className="text-white text-center px-20 py-6 mt-20 text-2xl bg-purple-700/20 rounded-lg max-w-[720px] mx-auto">
                      You don&#39;t have any{" "}
                      <span className="font-bold">YOUR NFTS</span> <br />
                      <div className="text-lg mt-3 flex items-center gap-2 justify-center">
                        Buy YOUR_COLLECTION on
                        <div className="flex items-center gap-1">
                          <Link href="https://magiceden.io/marketplace/your_collection">
                            <Image
                          ...
                          <Link href="https://www.tensor.trade/trade/your_collection">
                            <Image
